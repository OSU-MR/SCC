...
pcs_transformations = {
    ...
    "FFP": [[1, 0, 0], [0, 1, 0], [0, 0, 1]],  # Feet First-Prone

    "HFDR": [[0, -1, 0], [-1, 0, 0], [0, 0, -1]],  # Head First-Decubitus Right
    "HFDL": [[0, 1, 0], [1, 0, 0], [0, 0, -1]],  # Head First-Decubitus Left 
    "FFDR": [[0, 1, 0], [-1, 0, 0], [0, 0, 1]],  # Feet First-Decubitus Right
    "FFDL": [[0, -1, 0], [1, 0, 0], [0, 0, 1]],  # Feet First-Decubitus Left
    "LFP": [[0, 0, -1], [0, 1, 0], [1, 0, 0]],  # Left First-Prone
    "LFS": [[0, 0, 1], [0, -1, 0], [1, 0, 0]],  # Left First-Supine
    "RFP": [[0, 0, 1], [0, 1, 0], [-1, 0, 0]],  # Right First-Prone
    "RFS": [[0, 0, -1], [0, -1, 0], [-1, 0, 0]],  # Right First-Supine
    "AFDR": [[0, 0, -1], [-1, 0, 0], [0, 1, 0]],  # Anterior First-Decubitus Right
    "AFDL": [[-1, 0, 0], [0, 0, -1], [0, 1, 0]],  # Anterior First-Decubitus Left
    "PFDR": [[0, 0, 1], [-1, 0, 0], [0, -1, 0]],  # Posterior First-Decubitus Right
    "PFDL": [[0, 0, -1], [1, 0, 0], [0, -1, 0]],  # Posterior First-Decubitus Left
}
