...
base_dir-----input_folder-----folder name of your datasets1

          |                |--folder name of your datasets2
          |                |              ...
          |		       --folder name of your datasetsn
          |
          |
          |
          ---output_folder-----correction map folder of your datasets1(these folders in the output folder 
			     |-----correction map folder of your datasets2      will be automatically created)
			     |                ...                 
                         --correction map folder of your datasetsn
...
displaying_results(base_dir=base_dir, input_folder=input_folder,
                   output_folder=output_folder, folder_names=folder_names, sli_idx=0, avg_idx=None, 
                   fig_h=5)
